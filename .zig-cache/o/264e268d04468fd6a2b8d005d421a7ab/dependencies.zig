pub const packages = struct {
    ...
    pub const dispatch = struct {
        pub const build_root = "H:\\GAME\\Project\\hsr\\new_temporary_pearlSR\\dispatch";
    ...
    pub const gameserver = struct {
        pub const build_root = "H:\\GAME\\Project\\hsr\\new_temporary_pearlSR\\gameserver";
    ...
    pub const program = struct {
        pub const build_root = "H:\\GAME\\Project\\hsr\\new_temporary_pearlSR\\program";
        pub const build_zig = @import("program");
        pub const deps: []const struct { []const u8, []const u8 } = &.{
            .{ "protocol", "protocol" },
            .{ "httpz", "1220cf9b8944def0907a43f208a004d9322c6f1972f86792d7f82527965020eb5fba" },
            .{ "tls", "12201a2aeb55d0c4a112c5a1806e4d90d734e0e4c21301d4b289f734c3412a883312" },
