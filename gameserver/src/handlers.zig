...
const DummyCmdList = [_]struct { CmdID, CmdID }{
    ...
    .{ CmdID.CmdGetAvatarDeliverRewardActivityDataCsReq, CmdID.CmdGetAvatarDeliverRewardActivityDataScRsp },
    ...
    .{ CmdID.CmdRecoverAllLineupCsReq, CmdID.CmdRecoverAllLineupScRsp },
    //avatar equip/skill
    .{ CmdID.CmdDressAvatarCsReq, CmdID.CmdDressAvatarScRsp },
    .{ CmdID.CmdDressRelicAvatarCsReq, CmdID.CmdDressRelicAvatarScRsp },
    .{ CmdID.CmdTakeOffRelicCsReq, CmdID.CmdTakeOffRelicScRsp },
    .{ CmdID.CmdTakeOffEquipmentCsReq, CmdID.CmdTakeOffEquipmentScRsp },
    .{ CmdID.CmdAvatarExpUpCsReq, CmdID.CmdAvatarExpUpScRsp },
    .{ CmdID.CmdUnlockSkillTreeCsReq, CmdID.CmdUnlockSkillTreeScRsp },
    .{ CmdID.CmdTakePromotionRewardCsReq, CmdID.CmdTakePromotionRewardScRsp },
    .{ CmdID.CmdMarkAvatarCsReq, CmdID.CmdMarkAvatarScRsp },
    .{ CmdID.CmdPromoteAvatarCsReq, CmdID.CmdPromoteAvatarScRsp },
    ...
    .{ CmdID.CmdExpUpEquipmentCsReq, CmdID.CmdExpUpEquipmentScRsp },
    .{ CmdID.CmdRankUpEquipmentCsReq, CmdID.CmdRankUpEquipmentScRsp },
    .{ CmdID.CmdPromoteEquipmentCsReq, CmdID.CmdPromoteEquipmentScRsp },
    //red dot / misc
