...
pub fn onQueryGateway(req: *httpz.Request, res: *httpz.Response) !void {
    ...
    proto.enable_design_data_bundle_version_update = true;
    proto.enable_video_bundle_version_update = true;
    proto.watermark_enable = true;
    proto.enable_upload_battle_log = true;
    proto.ftc_switch = true;
    proto.enable_save_replay_file = true;
    proto.android_middle_package_enable = true;
    ...
    proto.NNFLHCGDGJM = true;
    proto.FMLPNNMJDIC = true;
