...
pub fn main() !void {
    ...
    const stderr: std.fs.File = std.io.getStdErr(); 
    stderr.writeAll(
        \\    ____  __    ___    _   _____    ____  _________    ____  _______ 
        \\   / __ \/ /   /   |  / | / /   |  / __ \/ ____/   |  / __ \/  _/   |
        \\  / /_/ / /   / /| | /  |/ / /| | / /_/ / /   / /| | / / / // // /| |
        \\ / ____/ /___/ ___ |/ /|  / ___ |/ _, _/ /___/ ___ |/ /_/ // // ___ |
        \\/_/   /_____/_/  |_/_/ |_/_/  |_/_/ |_|\____/_/  |_/_____/___/_/  |_|
        \\
        \\
    ) catch {};
